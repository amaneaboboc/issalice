...
class Filter {
 ...
 public:
  ...
  virtual bool accept(const T &object __attribute__((unused))) { return true; }

  void addCondition(unsigned int type, unsigned int subtype, double minimum,
                    double maximum) {
  ...
  void setTitle(const TString &newTitle) { title = newTitle; }
