...
//!
void reduce_n1EtaPhiN1EtaPhiOntoN1N1DetaDphi(const TH2 *h_1, TH2 *h_2,
                                             TH2 *h_12, int nDeta, int nDphi) {
...
double calculateN1N1_H1H1H2(const TH1 *h_1, const TH1 *h_2, TH2 *h_12,
                            double a1, double a2) {
  // if (reportStart(__FUNCTION__))
  ;
...
void calculateR2_H2H2H2(const TH2 *n2_12, const TH2 *n1n1_12, TH2 *r2_12,
