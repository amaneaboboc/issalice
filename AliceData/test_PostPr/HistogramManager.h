...
class ParticleSingleHistos {
 public:
  ...
  void fill(Track trk, double weight) {
    ...
    void readHistograms(TFile * inputFile, TString & str1) {
        ...
        h_n1_phiEta = loadH2(inputFile, createName(str1,"n1_phiEta"));
       // h_n1_phiY = loadH2(inputFile,str1);
        cout<< "import histo : "<<createName(str1,"n1_phiEta")<<endl;


        if(!h_n1_phiEta)
        {
        cout<<"Histo not found"<<'\n'<<createName(str1,"n1_phiEta")<<endl;
        }
...
//        h_n1_phiY = loadH2(inputFile, createName("h",str1,"_DyDphi"));
      h_n2_DetaDphi = loadH2(inputFile, createName(str1,"n2_DetaDphi"));
      cout<< "import histo : "<<createName(str1,"n2_DetaDphi")<<endl;
