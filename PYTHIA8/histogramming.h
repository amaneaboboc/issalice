...
TH1D * createHistogram(const TString & name,
                                           ...
                                           const TString & title_y)
{
 ...
 //std::cout << "Creating  1D histo " << name << " with " << n << " non uniform nBins:" << endl;
...
TH2D * createHistogram(const TString & name,
                                           ...
                                           const TString & title_z )
{
   ...
   // std::cout << "Creating  2D histo " << name << " n_x:" << n_x << " min_x:" << min_x << " max_x:" << max_x << " n_y:" << n_y << " min_y:" << min_y << " max_y:" << max_y<< endl;
  TH2D * h;
...

{
    ...
    //std::cout << "Creating  2D histo " << name << " with " << n_x << " vs " << n_y << " non uniform nBins:" << endl;
  TH2D * h;
...
// Create 3D histogram
//!
TH3D * createHistogram(const TString & name,
                                           int n_x, double min_x, double max_x,
                                           int n_y, double min_y, double max_y,
...

{
 ...
 //   << " n_x:" << n_x << " min_x:" << min_x << " max_x:" << max_x << " X:" << title_x
   ...
   // << " W:" << title_w  << endl;
  TH3D * h;
  h = new TH3D(name,name,n_x,min_x,max_x,n_y,min_y,max_y,n_z,min_z,max_z);
  if (title_x.Sizeof()>0)  h->GetXaxis()->SetTitle(title_x);
  if (title_y.Sizeof()>0)  h->GetYaxis()->SetTitle(title_y);
  if (title_z.Sizeof()>0)  h->GetZaxis()->SetTitle(title_z);
  return h;
                                              ...
                                              const TString & title_y)
{
  ...
  //cout << "Creating  1D profile " << name << " n_x:" << n_x << " min_x:" << min_x << " max_x:" << max_x << endl;
...
//!
TProfile2D * createProfile(const TString & name,
                                                int n_x, double min_x, double max_x,
                                                int n_y, double min_y, double max_y,
                                                const TString & title_x,
                                                const TString & title_y,
