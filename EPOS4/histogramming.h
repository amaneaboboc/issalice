...
TH1D *
createHistogram (const TString &name, int n, double min_x, double max_x,
...
TH1D *
createHistogram (const TString &name, int n, double *bins,
                 const TString &title_x, const TString &title_y)
{
...
TH2D *
createHistogram (const TString &name, int n_x, double min_x, double max_x,
                 int n_y, double min_y, double max_y, const TString &title_x,
...
TH2D *
createHistogram (const TString &name, int n_x, double *xbins, int n_y,
...
TH3D *
createHistogram (const TString &name, int n_x, double min_x, double max_x,
                 int n_y, double min_y, double max_y, int n_z, double min_z,
                 double max_z, const TString &title_x, const TString &title_y,
                 const TString &title_z, const TString &title_w = "w")
...
//!
TProfile *
createProfile (const TString &name, int n_x, double min_x, double max_x,
               const TString &title_x, const TString &title_y)
{
...
//!
TProfile *
createProfile (const TString &name, int n_x, double *bins,
               const TString &title_x, const TString &title_y)
{
...
const TString
createName (const TString &s0, const TString &s1, int option = 0)
{
  TString separator;
  switch (option)
    {
...
const TString
createName (const TString &s0, const TString &s1, const TString &s2,
            int option = 0)
{
  TString separator;
  switch (option)
...
const TString
createName (const TString &s0, const TString &s1, const TString &s2,
            const TString &s3, const TString &s4, int option = 0)
{
  TString separator;
  switch (option)
    {
